          ...
          <Reveal delay={100}>
            ...
            <div className="relative mt-6 md:mt-10">
              ...
              <button
                ...
                className="group absolute -left-10 top-1/2 z-10 hidden -translate-y-1/2 p-2 text-foreground/40 transition-colors hover:text-foreground md:block"
              >
                <ChevronLeft
              ...
              <button
                ...
                className="group absolute -right-10 top-1/2 z-10 hidden -translate-y-1/2 p-2 text-foreground/40 transition-colors hover:text-foreground md:block"
              >
                <ChevronRight
                  className="h-8 w-8 transition-transform duration-300 group-hover:translate-x-1"
                  strokeWidth={0.75}
